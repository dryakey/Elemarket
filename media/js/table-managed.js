var TableManaged = function() {
	...
	return {
		...
		init: function() {
			...
			jQuery('#sample_3_wrapper .dataTables_length select').select2(); // initialzie select3 dropdown
			...
			jQuery('#sample_4_wrapper .dataTables_length select').select2(); // initialzie select4 dropdown
			...
			jQuery('#sample_5_wrapper .dataTables_length select').select2(); // initialzie select5 dropdown
